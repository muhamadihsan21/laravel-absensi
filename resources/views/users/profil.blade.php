            ...
            <div class="card-body">
                <form action=" {{ route('update-profil', Auth::user()->id) }} " method="post" enctype="multipart/form-data">
                    ...
                    <div class="text-center mb-3">
                        <img src="{{ asset('storage/' . Auth::user()->foto) }}" class="img-thumbnail" width="150">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jabatan" value="{{ old('jabatan', auth()->user()->jabatan) }}" disabled>
                    </div>
